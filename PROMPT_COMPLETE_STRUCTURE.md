...
## Contexto
Crear una aplicación Next.js 14+ completa con App Router que se conecte a la API de Splitia en `http://localhost:8080/api`. La aplicación debe incluir todas las rutas, componentes, servicios, hooks y tipos TypeScript basados en la API REST del backend.
