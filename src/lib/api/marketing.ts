...
export const marketingApi = {
  ...
  getAllCampaigns: async (pageable?: Pageable): Promise<ApiResponse<Page<CampaignResponse>>> => {
    ...
    apiLogger.general({ endpoint: 'getAllCampaigns', success: response.success, params: pageable, data: response.data });
  ...
  getCampaignById: async (id: string): Promise<ApiResponse<CampaignResponse>> => {
    ...
    apiLogger.general({ endpoint: 'getCampaignById', success: response.success, params: { id }, data: response.data });
    return response.data;
  },
  ...
  createCampaign: async (data: CreateCampaignRequest): Promise<ApiResponse<CampaignResponse>> => {
    ...
    apiLogger.general({ endpoint: 'createCampaign', success: response.success, params: { data }, data: response.data });
    return response.data;
  },
  ...
  updateCampaign: async (id: string, data: UpdateCampaignRequest): Promise<ApiResponse<CampaignResponse>> => {
    ...
    apiLogger.general({ endpoint: 'updateCampaign', success: response.success, params: { id, data }, data: response.data });
    return response.data;
  },
  ...
  deleteCampaign: async (id: string): Promise<ApiResponse<void>> => {
    ...
    apiLogger.general({ endpoint: 'deleteCampaign', success: response.success, params: { id } });
    return response.data;
  },
  ...
  getAllWorkflows: async (pageable?: Pageable): Promise<ApiResponse<Page<WorkflowResponse>>> => {
    ...
    apiLogger.general({ endpoint: 'getAllWorkflows', success: response.success, params: pageable, data: response.data });
    return response.data;
  },
  ...
  getWorkflowById: async (id: string): Promise<ApiResponse<WorkflowResponse>> => {
    ...
    apiLogger.general({ endpoint: 'getWorkflowById', success: response.success, params: { id }, data: response.data });
    return response.data;
  },
  ...
  createWorkflow: async (data: CreateWorkflowRequest): Promise<ApiResponse<WorkflowResponse>> => {
    ...
    apiLogger.general({ endpoint: 'createWorkflow', success: response.success, params: { data }, data: response.data });
    return response.data;
  },
  ...
  updateWorkflow: async (id: string, data: Partial<CreateWorkflowRequest>): Promise<ApiResponse<WorkflowResponse>> => {
    ...
    apiLogger.general({ endpoint: 'updateWorkflow', success: response.success, params: { id, data }, data: response.data });
    return response.data;
  },
  ...
  deleteWorkflow: async (id: string): Promise<ApiResponse<void>> => {
    ...
    apiLogger.general({ endpoint: 'deleteWorkflow', success: response.success, params: { id } });
    return response.data;
  },
  ...
  getAllLandingPages: async (pageable?: Pageable): Promise<ApiResponse<Page<LandingPageResponse>>> => {
    ...
    apiLogger.general({ endpoint: 'getAllLandingPages', success: response.success, params: pageable, data: response.data });
    return response.data;
  },
  ...
  getLandingPageById: async (id: string): Promise<ApiResponse<LandingPageResponse>> => {
    ...
    apiLogger.general({ endpoint: 'getLandingPageById', success: response.success, params: { id }, data: response.data });
    return response.data;
  },
  ...
  createLandingPage: async (data: CreateLandingPageRequest): Promise<ApiResponse<LandingPageResponse>> => {
    ...
    apiLogger.general({ endpoint: 'createLandingPage', success: response.success, params: { data }, data: response.data });
    return response.data;
  },
  ...
  updateLandingPage: async (id: string, data: Partial<CreateLandingPageRequest>): Promise<ApiResponse<LandingPageResponse>> => {
    ...
    apiLogger.general({ endpoint: 'updateLandingPage', success: response.success, params: { id, data }, data: response.data });
    return response.data;
  },
  ...
  deleteLandingPage: async (id: string): Promise<ApiResponse<void>> => {
    ...
    apiLogger.general({ endpoint: 'deleteLandingPage', success: response.success, params: { id } });
    return response.data;
  },
};
