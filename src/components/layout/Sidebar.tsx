...
const adminNavigation = [
  ...
  { name: 'Oportunidades', href: '/admin/crm/sales/opportunities', icon: TrendingUp },
  ...
  { name: 'Inventario', href: '/admin/inventory/products', icon: Package },
  { name: 'Proveedores', href: '/admin/procurement/vendors', icon: Building2 },
  { name: 'RRHH', href: '/admin/hr/employees', icon: Briefcase },
